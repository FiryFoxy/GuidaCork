// Meteo Cork — Open-Meteo (gratuito, senza API key)
...
function renderTips(tips, erasmus) {
  ...
  return `
    ...
    <p class="text-xs text-gray-500 mt-4 text-center">
      ...
      Ufficiale: <a href="${tips.links[0].url}" target="_blank" rel="noopener" class="underline">Met Éireann</a>
    ...
    <div class="weather-now">
      <div class="weather-now-main">
        ...
        <div>
          ...
          <div class="text-sm opacity-80">Percepita ${Math.round(current.apparent_temperature)}°C · Cork</div>
        </div>
      </div>
  ...
  try {
    ...
    rootEl.innerHTML = `
      <div class="empty-state">
        ...
        <p class="text-sm text-gray-500 mt-2">Controlla la connessione o visita <a href="https://www.met.ie/forecast/location/cork" target="_blank" rel="noopener" class="underline">Met Éireann</a>.</p>
      </div>
...
window.CorkWeather = { init: initWeather };
