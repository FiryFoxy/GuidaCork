// Planner uscite Cork Erasmus — 11 luglio / 12 agosto 2026
const PLANNER_KEY = 'uscitePlannerCork2026';
const FAVORITES_KEY = 'favoritesCork2026';
...
function exportPlansJSON() {
  ...
  a.download = 'planner-cork-2026.json';
  a.click();
